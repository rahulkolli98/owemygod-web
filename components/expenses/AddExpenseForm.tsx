...
type AddExpenseFormValues = z.input<typeof addExpenseSchema>;
...
export function AddExpenseForm({ groupId, members, currency = "USD" }: AddExpenseFormProps) {
  ...
  function handleSplitTypeChange(nextSplitType: SplitType) {
    ...
    const defaults = createSplitDefaults(nextSplitType, selectedParticipants ?? [], getAmountNumber());
    setValue("splitValues", defaults, { shouldValidate: true });
  }
